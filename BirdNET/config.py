...
MODEL_PATH = 'BirdNET/checkpoints/V2.2/BirdNET_GLOBAL_3K_V2.2_Model_FP32.tflite'
MDATA_MODEL_PATH = 'BirdNET/checkpoints/V2.2/BirdNET_GLOBAL_3K_V2.2_MData_Model_FP16.tflite'
LABELS_FILE = 'BirdNET/checkpoints/V2.2/BirdNET_GLOBAL_3K_V2.2_Labels.txt'
TRANSLATED_LABELS_PATH = 'BirdNET/labels/V2.2'
